    ...
    <div class="px-6 py-4 bg-white dark:bg-gray-900 w-full space-y-4">
        <div class=" flex justify-between">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="table-search" v-model="searchInput" @keyup="searchForTerm" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50
                            focus:ring-purchaser-primary focus:border-purchaser-primary" placeholder="Suche">
            </div>
