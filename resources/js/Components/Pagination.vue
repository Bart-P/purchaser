        ...
        <div class="flex gap-5 xs:mt-0">
            ...
            <ul class="flex gap-1 items-center">
                <li v-if="props.data.current_page > 3">
                    <Link :href="props.data.first_page_url" class="cursor-default px-4 py-2 rounded text-white bg-purchaser-primary cursor-pointer hover:bg-purchaser-primary-dark">
                        <i class="fa-solid fa-angles-left"></i>
                    </Link>
                </li>
                <li>
                    <Link v-if="props.data.prev_page_url"
                ...
                <li>
                    <Link v-if="props.data.next_page_url"
                ...
                <li v-if="props.data.current_page + 2 < props.data.last_page">
                    <Link :href="props.data.last_page_url" class="cursor-default px-4 py-2 rounded text-white bg-purchaser-primary cursor-pointer hover:bg-purchaser-primary-dark ">
